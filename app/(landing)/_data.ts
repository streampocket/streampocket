...
export const LANDING_STEPS: LandingStep[] = [
  {
    ...
    title: '1. 파티 둘러보기',
    description:
      '드라마박스, 드라마웨이브, 비글루, 숏맥스, 플릭릴스 등 원하는 OTT의 모집 중인 파티를 확인하세요.',
  },
  {
    id: 'signup',
    title: '2. 회원가입 / 로그인',
...
export const LANDING_FAQS: LandingFaq[] = [
  {
    ...
    answer:
      'OTTALL(오티티올)은 드라마박스, 드라마웨이브, 비글루, 릴숏, 넷숏, 숏맥스, 플릭릴스 등 OTT멤버십(구독권)을 파티(쉐어)로 나눠 저렴하게 이용하도록 파티원을 매칭해주는 플랫폼입니다. 파티장이 파티를 개설하고 파티원을 모집하면, OTTALL이 안전하게 매칭을 도와드립니다.',
  },
  {
    id: 'difference-faq',
