 ...
 * 스토어 차별점을 안내해 구매자 불안을 줄이고 카톡 문의를 유도한다.
 */
export function CountryChangePromo() {
  return (
    <div className="mt-4 space-y-3 rounded-lg border border-brand-light bg-brand-light/40 p-4">
      ...
      <p className="text-center text-caption-md text-text-secondary md:text-base">
      ...
      <ul className="space-y-1.5 text-caption-md md:text-base">
      ...
      <div className="space-y-1.5 text-caption-md text-text-secondary md:text-base">
        <p>
